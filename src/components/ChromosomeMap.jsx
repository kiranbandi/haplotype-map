...
class ChromosomeMap extends Component {
    ...
    render() {
        ...
        return (<div className='subchart-container' >
            ...
            {referenceType == 'trait' && <TraitMap triggerCompare={this.props.triggerCompare} lineCount={lineCount} trait={trait} traitList={traitList} traitMap={traitMap} treeID='chromosomeTraitMap' />}
